...
public QqDataBaseHistory(){}
	...
	// 三问号格式
	public QqDataBaseHistory(String qq,String qqPwd,String question1,String question1_answer,String question2,String question2_answer,String question3,String question3_answer){
		Date now = new Date();
		this.setCreateTime(now);
		this.setPwd(qqPwd);
		this.setQq(qq);
	...
	// 绑机号格式
	public QqDataBaseHistory(String qq,String qqPwd,String question1,String question1_answer,String question2,String question2_answer,String question3,String question3_answer,String mobile){
		Date now = new Date();
		this.setCreateTime(now);
		this.setPwd(qqPwd);
		this.setQq(qq);
