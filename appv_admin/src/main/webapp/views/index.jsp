	...
	<header class="am-topbar am-topbar-inverse admin-header">
		<div class="am-topbar-brand">
			<a href="javascript:;" class="tpl-logo"> <img
				src="<%=basePath%>/assets/img/logo.jpg" alt="">
			</a>
		</div>
				...
				<ul class="tpl-left-nav-menu">
                    ...
                    <li class="tpl-left-nav-item"><a href="javascript:void(0);"
                        class="nav-link tpl-left-nav-link-list"> <i
                            class="am-icon-cog"></i> <span>APP版本管理</span> <i
                        ...
                        <ul class="tpl-left-nav-sub-menu" style="display: none;">
                            ...
                            <a href="javascript:loadRight('<%=basePath %>/appv/appList','APP列表')"> <i
                                    class="am-icon-angle-right"></i> <span>APP列表</span>
                            </a>
                            </shiro:hasPermission>
                            </li>
						...
						<div class="tpl-portlet">
							<div class="tpl-portlet-title">
								<div class="tpl-caption font-green ">
									<i class="am-icon-cloud-download"></i> <span> 数据统计</span>
								</div>
							</div>
		...
		<!-- 右边主要更新内容 end -->
			<footer data-am-widget="footer" class="am-footer am-footer-default"
				...
				<div class="am-footer-miscs ">
					...
					<p>
						由 <a href="http://www.gwemall.cn/" title="GZYZ" target="_blank"
							class="">GZYZ</a> 提供技术支持
					</p>
					<p>CopyRight©2017 APPV Inc.</p>
				</div>
			</footer>
		</div>
		<!-- 右边内容 end -->
...
<!-- amaze ui 模态窗口 end -->
	...
	<!-- 文件上传 -->
	<script src="<%=basePath %>/components/fileupload/jquery.ui.widget.js"></script>
	<script src="<%=basePath %>/components/fileupload/jquery.fileupload.js"></script>
	<script src="<%=basePath %>/components/fileupload/jquery.iframe-transport.js"></script>
</body>
